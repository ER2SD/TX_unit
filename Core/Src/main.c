  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
  	...
  	//NRF24L01_Send(buf1);
  	    ...
  	    // KEY_6
  	    // -----------------------------------------
  	    if(HAL_GPIO_ReadPin(KEY_6_GPIO_Port,KEY_6_Pin) == GPIO_PIN_RESET)
  	    {
  	        tx_buf[0] = 0x06;
  	        NRF24L01_Send(tx_buf);
  	        HAL_Delay(200);
  	    ...
  	    // KEY_7
  	    // -----------------------------------------
  	    if(HAL_GPIO_ReadPin(KEY_7_GPIO_Port,KEY_7_Pin) == GPIO_PIN_RESET)
  	    {
  	        tx_buf[0] = 0x07;
  	        NRF24L01_Send(tx_buf);
  	        HAL_Delay(200);
  	    ...
  	    // KEY_8
  	    // -----------------------------------------
  	    if(HAL_GPIO_ReadPin(KEY_8_GPIO_Port,KEY_8_Pin) == GPIO_PIN_RESET)
  	    {
  	        tx_buf[0] = 0x08;
  	        NRF24L01_Send(tx_buf);
  	        HAL_Delay(200);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_Pin|Relay_Pin|NRF_CSN_Pin|NRF_CE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : KEY_4_Pin KEY_5_Pin KEY_6_Pin KEY_7_Pin
                           KEY_8_Pin */
